...
if(file.exists(paste("../../../emma_toolbox_data/Raw/VerbalMemory/verbalmem-vervolg-subject-",subj,".csv",sep=""))){ 
  ...
  retrieval <- NA
  retrieval_incorrect <- NA
  retrieval_double <- NA

  selected_items_retrieval <- NA

  recognition_correct <- NA
  selected_items_recognition <- NA
