...
for (condition in c("fixed", "random")){
  for (speed in c(2, 4, 6, 8)){
    ...
    if(file.exists(paste0("../../../emma_toolbox_data/Raw/VisuoMotor/VisuoMotor_v1.0.osexp_subj",subj_corr,"_",condition,"_step_",speed,".txt",sep=""))){
      mydata <- read.delim(paste0("../../../emma_toolbox_data/Raw/VisuoMotor/VisuoMotor_v1.0.osexp_subj",subj_corr,"_",condition,"_step_",speed,".txt",sep=""), header=TRUE, sep=" ", dec=".")
}

    if(file.exists(paste0("../../../emma_toolbox_data/Raw/VisuoMotor/Rups_v1.0.osexp_subj",subj_corr,"_",condition,"_step_",speed,".txt",sep=""))){
      mydata <- read.delim(paste0("../../../emma_toolbox_data/Raw/VisuoMotor/Rups_v1.0.osexp_subj",subj_corr,"_",condition,"_step_",speed,".txt",sep=""), header=TRUE, sep=" ", dec=".")
}

    write.table(mydata, file = paste0("../../../emma_toolbox_data/Raw/VisuoMotor/VisuoMotor_v1.0.osexp_subj",subj,"_",condition,"_step_",speed,"_",emmadate,".txt",sep=""), sep=" ", dec=".")
...
all_data <- read_csv(paste("../../../emma_toolbox_data/Raw/VisuoMotor/visuomotor-subject-",subj,".csv",sep=""), col_types = cols())
