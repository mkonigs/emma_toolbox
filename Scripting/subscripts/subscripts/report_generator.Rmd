...
dirs <- c("pos", "pos", "pos")
des <- c("Processing speed", "Processing Stability", "Processing Consistency")
trrs <- c(NA, NA, NA)

scales <-c("Mean Reaction Time (z-score)", "SD as percentage of MRT (z-score)", "Tau as percentage of MRT (z-score)")
